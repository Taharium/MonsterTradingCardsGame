...
REM --------------------------------------------------
echo 22) check history
echo.
echo get trading history
echo.
curl -X GET http://localhost:10001/history/tradings --header "Authorization: Bearer kienboec-mtcgToken"
echo.
curl -X GET http://localhost:10001/history/tradings --header "Authorization: Bearer altenhof-mtcgToken"
echo.
echo get trading history detailed
echo.
curl -X GET http://localhost:10001/history/tradings?detailed=true --header "Authorization: Bearer kienboec-mtcgToken"
echo.
curl -X GET http://localhost:10001/history/tradings?detailed=true --header "Authorization: Bearer altenhof-mtcgToken"
echo.
echo get trading history detailed in plain format
echo.
curl -X GET "http://localhost:10001/history/tradings?detailed=true&format=plain" --header "Authorization: Bearer kienboec-mtcgToken"
echo.
curl -X GET "http://localhost:10001/history/tradings?detailed=true&format=plain" --header "Authorization: Bearer altenhof-mtcgToken"
echo.
echo get battle history
echo.
curl -X GET http://localhost:10001/history/battles --header "Authorization: Bearer kienboec-mtcgToken"
echo.
curl -X GET http://localhost:10001/history/battles --header "Authorization: Bearer altenhof-mtcgToken"
echo.
echo.
...
echo 23) Stats Ratio
echo kienboec
curl -X GET http://localhost:10001/stats?ratio=true --header "Authorization: Bearer kienboec-mtcgToken"
echo.
echo.
echo altenhof
curl -X GET http://localhost:10001/stats?ratio=true --header "Authorization: Bearer altenhof-mtcgToken"
echo.
echo.
